    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
          <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Pharmacy Store Products - Remove Item</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">
            <div class="margin">
				
				<form action="action_remove_item.php" method="POST">
					<div class="container" style = "text-align:start";>
						<h1>Remove Store Items</h1>
						<p>Please fill in this form to remove a store item</p>
						<hr>
						...
						<button type="submit" name="submit" class="registerbtn">Filter</button>
					</div>
				</form>
				...
				<?php
					fetchStoreData("nutrition_supplement");
				?>
